...
cb.MapModel = function(mapView) {
	...
	this.activateRegion = function(regionCode) {
		...
		var oldConJsonPath = 'C:/Users/Paul/Desktop/font-awesome-4.7.0/small_state_institute_dashboard/alpha/scripts/constituencies/' + regionCode + '.json';
		d3.json(oldConJsonPath, downloadOldCons);

		// Download old constituencies
		var newConJsonPath = 'C:/Users/Paul/Desktop/font-awesome-4.7.0/small_state_institute_dashboard/alpha/scripts/constituencies/old/' + regionCode + '.json';
